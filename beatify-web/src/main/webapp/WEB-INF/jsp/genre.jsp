...
<html>
    ...
    <body>
        ...
        <div class="dynamic">
            ...
            <div id="mainContent">
                <h4>Trending in ${genre}</h4>
                <div id="recipeCarousel" class="col-md-6 carousel slide w-100" data-ride="carousel">
                    <div class="carousel-inner w-100" role="listbox">
                        <div class="carousel-item row no-gutters active">
                            <c:forEach items="${trendingInGenrePart1}" var="album">
                                <div class="col-3 float-left">
                                    <c:set var="albumCover" value="${album.songs.iterator().next().albumCover.serverURL}"/>
                        ...
                        <div class="carousel-item row no-gutters">
                            <c:forEach items="${trendingInGenrePart2}" var="album">
                                <div class="col-3 float-left">
                                    <c:set var="albumCover" value="${album.songs.iterator().next().albumCover.serverURL}"/>
                                    <a href="<c:url value="/albums/${album.id}"/>">
                                        <img class="img-fluid" data-target="${album.id}" style="cursor: pointer;"  src="${albumCover}">
